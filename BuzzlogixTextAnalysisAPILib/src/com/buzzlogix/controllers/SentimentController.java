...
public class SentimentController extends BaseController {
    ...
    * Constructor with authentication and configuration parameters */
    public SentimentController (String apikey) {
        this.apikey = apikey;
    }

   /**
    * Constructor with authentication and configuration parameters */
    public SentimentController (HttpClient _client, String apikey) {
        super(_client);
        this.apikey = apikey;
    }
    ...
    public void createReturnEnglishGeneralSentimentAsync(
        ...
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5298971068447024737L;
            {
    ...
    public void createReturnEnglishGeneralSentimentFormAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4720535472817408063L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "apikey", apikey );
