...
public class KeywordsController extends BaseController {
    ...
    * Constructor with authentication and configuration parameters */
    public KeywordsController (String xMashapeKey) {
        this.xMashapeKey = xMashapeKey;
    }

   /**
    * Constructor with authentication and configuration parameters */
    public KeywordsController (HttpClient _client, String xMashapeKey) {
        super(_client);
        this.xMashapeKey = xMashapeKey;
    }
    ...
    public void createReturnEnglishKeywordsTextPlainAsync(
        ...
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5700561474471721215L;
            {
    ...
    public void createReturnEnglishKeywordsMultipartFormDataAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4665295708684994689L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "X-Mashape-Key", xMashapeKey );
        ...
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5674285023082564574L;
            {
                    put( "text", text );
            }
        };
    ...
    public void createReturnEnglishKeywordsXWwwFormUrlencodedAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5536849897896751958L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "X-Mashape-Key", xMashapeKey );
        ...
        //load all fields for the outgoing API request
        Map<String, Object> parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5051005012571204093L;
            {
                    put( "text", text );
            }
        };
